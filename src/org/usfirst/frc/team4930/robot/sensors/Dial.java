    ...
    if (getDialNum != Robot.dialNumber) {
      ...
      switch (Robot.dialNumber) {
        ...
        case 8:
          ...
          break;
        case 9:
          Robot.autoDescription = "(09r) Place Gear And Unload Fuel";
